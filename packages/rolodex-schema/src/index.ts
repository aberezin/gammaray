// Rolodex (the contact-CRM example app) data model: the TableDescriptors for its
// type-A tables. These are *example* definitions built on the @gammaray/core
// framework (FieldKind / TableDescriptor / merge strategies) — swap this package
// out to drive a different app from the same engine.
...
export const rolodexDescriptors: TableDescriptor[] = [
  companyDescriptor,
  tagDescriptor,
  categoryDescriptor,
  contactDescriptor,
